        ...
        foreach ($rawUsers as $user => $data) {
            //if (isset($data["dept"]) && $data["dept"] == self::DEPARTMENT) {
                $users[] =  [
                    ...
                    "calls_limit" => isset($data["calls_limit"]) ? $data["calls_limit"] : 0,
                    ...
                    "chats_limit" => isset($data["chats_limit"]) ? $data["chats_limit"] : 0,
                    ...
                    "omni_time" => isset($data["omni_time"]) ? $data["omni_time"] : 0,
                    "punched" => isset($data["punched"]) ? $data["punched"] : 0,
                    "punched_eos" => isset($data["punched_eos"]) ? $data["punched_eos"] : 0,
                    "punched_offshift" => isset($data["punched_offshift"]) ? $data["punched_offshift"] : 0,
                    "punched_scheduled" => isset($data["punched_scheduled"]) ? $data["punched_scheduled"] : 0,
                    "punched_scheduled_miss" => isset($data["punched_scheduled_miss"]) ? $data["punched_scheduled_miss"] : 0,
